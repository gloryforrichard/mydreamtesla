...
export const POPULAR_COMPARISONS = [
	...
	},
	{
		...
		description: 'The entry-level Model 3 before and after the Highland redesign.',
	},
	...
	},
	{
		...
		description: 'Performance sedan vs performance SUV — which is the better daily driver?',
	},
	// ── Within Model Y ────────────────────────────────────────────────────
	{
		...
		description: 'Is the range and AWD upgrade worth the extra cost on Model Y?',
	},
	{
