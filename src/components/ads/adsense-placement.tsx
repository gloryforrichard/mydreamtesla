 ...
 */
export function AdSensePlacement({ format, slot, className = '' }: AdSensePlacementProps) {
	...
	return (
		<aside aria-label="Advertisement" className={`mx-auto ${className}`} style={{ maxWidth: size.width }}>
			<ins
				ref={adRef}
