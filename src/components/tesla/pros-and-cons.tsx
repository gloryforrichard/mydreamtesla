...
export function ProsAndCons({ prosAndCons }: ProsAndConsProps) {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      <div className="rounded-sm border border-green-200/60 bg-green-50/30 p-4 sm:p-6">
      ...
      <div className="rounded-sm border border-red-200/60 bg-red-50/30 p-4 sm:p-6">
